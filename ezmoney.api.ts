...
// @public
declare function format<C extends string>(monetaryValue: MonetaryValue<C>, locale?: string | string[], options?: MonetaryValueFormatOptions): string;
...
// @public
declare function unsafeFormat<C extends string>(monetaryValue: MonetaryValue<C>, locale?: string | string[], formatOptions?: MonetaryValueFormatOptions): string;
